...
-- CreateEnum
CREATE TYPE "SupportTicketStatus" AS ENUM ('OPEN', 'IN_PROGRESS', 'WAITING_ON_CUSTOMER', 'RESOLVED', 'CLOSED', 'ESCALATED');
...
CREATE TABLE "UsageSnapshot" (
    ...
    "liveSessionsCount" INTEGER NOT NULL,
    "quizAttemptsCount" INTEGER NOT NULL,
...
-- CreateIndex
CREATE INDEX "UsageSnapshot_tenantId_periodStart_periodEnd_idx" ON "UsageSnapshot"("tenantId", "periodStart", "periodEnd");

-- CreateIndex
CREATE INDEX "BillingInvoice_tenantId_subscriptionId_createdAt_idx" ON "BillingInvoice"("tenantId", "subscriptionId", "createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "BillingInvoice_tenantId_invoiceNumber_key" ON "BillingInvoice"("tenantId", "invoiceNumber");

-- CreateIndex
CREATE INDEX "SupportTicket_tenantId_status_priority_createdAt_idx" ON "SupportTicket"("tenantId", "status", "priority", "createdAt");

-- CreateIndex
CREATE INDEX "SupportTicketComment_tenantId_ticketId_createdAt_idx" ON "SupportTicketComment"("tenantId", "ticketId", "createdAt");
...
-- AddForeignKey
ALTER TABLE "UsageSnapshot" ADD CONSTRAINT "UsageSnapshot_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BillingInvoice" ADD CONSTRAINT "BillingInvoice_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SupportTicket" ADD CONSTRAINT "SupportTicket_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SupportTicketComment" ADD CONSTRAINT "SupportTicketComment_ticketId_fkey" FOREIGN KEY ("ticketId") REFERENCES "SupportTicket"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
